...
export interface SecondaryTokenInput {
    ...
    /**
     * 
     * @type {SecondaryTokenInputBeneficiaryID}
     * @memberof SecondaryTokenInput
     */
    'beneficiaryID': SecondaryTokenInputBeneficiaryID;
    /**
     * The token represented in hexadecimal format.
     * @type {string}
     * @memberof SecondaryTokenInput
 ...
 * @export
 */
export type SecondaryTokenInputBeneficiaryID = string;
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async createSecondaryTokenForRequest(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SecondaryTokenOutput>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.createSecondaryTokenForRequest']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Disables a primary token with the given serviceProviderID and addressID.
...
export class DefaultApi extends BaseAPI {
    ...
    public createSecondaryTokenForRequest(id: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).createSecondaryTokenForRequest(id, options).then((request) => request(this.axios, this.basePath));
    }
